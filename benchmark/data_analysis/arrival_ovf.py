...
# ◆ arrival rates는 리스트로
arrival_list = [1.0,1.5, 2.0, 2.5, 3.0, 3.5, 4.0]
ovf_list     = []

for rate in arrival_list:
    
    json_path = f"/home/heelim/vllm/build_trace/selected_traces/arrival_rate_CV/SS06_SM02_SL13_MS06_MM04_ML06_LS51_LM09_LL05/blocks_611/lognormal_lambda{rate}x_cv1/lognormal_lambda{rate}x_cv1.metrics.json"
    try:
...
plt.tight_layout()
plt.savefig("figures/arrival_ovf.jpg", bbox_inches="tight", dpi=300)
