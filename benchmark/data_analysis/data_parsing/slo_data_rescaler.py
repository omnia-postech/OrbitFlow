        ...
        for method in methods:
            for rate in args.arrival_rate_list:
                for cv in args.cv_list:
                    ...
                    old_sc_str = str(int(old_sc)) if old_sc == int(old_sc) else str(old_sc)
                    old_path = os.path.join(
                        base_path, f"slo{old_sc_str}", method,
                    ...
                    for new_sc in new_sc_list:
                        ...
                        new_sc_str = str(int(new_sc)) if new_sc == int(new_sc) else str(new_sc)
                        new_path = os.path.join(
                            base_path, f"slo{new_sc_str}", method,
