...
method_labels = ["Flexgen", "DeepSpeed", "SelectN", "No Prefetch", "Ours"]
metric_list = [
    # "Low", 
    "Mid", 
    # "High"
...
# y축 정렬 및 간격 조정
plt.subplots_adjust(left=0.07, right=0.99, top=0.90, bottom=0.08, wspace=0.075, hspace=0.3)
...
for i, metric in enumerate(metric_list):
    for j, (trace, trace_label) in enumerate(zip(trace_list, trace_labels)):
        ...
        ax.set_title(trace_label, fontsize=font_size)
...
plt.savefig("figures/6_3_throughput_total_compare.jpg", format='jpg', bbox_inches="tight")
plt.savefig("figures/6_3_throughput_total_compare.pdf", format='pdf', bbox_inches="tight")