...
# 공통 경로
base_path="/home/heelim/vllm/outputs/benchmark/paper_main_exp_CV"  # change here
...
python /home/heelim/vllm/benchmark/data_analysis/cv/arrival_rate_cv_tbt_tpot.py "${base_path}"
if [ $? -ne 0 ]; then
