...
# 공통 경로
base_path="/home/heelim/vllm/outputs/benchmark/paper_main_exp_design_validation"  # change here
...
#   "slo1/UniformSolver"
  # "slo1.5/UniformSolver"
#   "slo2.5/UniformSolver"

#   "slo1/UniformSolver_TD"
  # "slo1.5/UniformSolver_TD"
#   "slo2.5/UniformSolver_TD"
...
python /home/heelim/vllm/benchmark/data_analysis/design_valid/design_validation.py "${base_path}"
if [ $? -ne 0 ]; then
