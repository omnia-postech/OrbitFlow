...
for i, sc in enumerate(slo_scales):
    ...
    try:
        ...
        for rate in arrival_rate:
            ...
            x_tbt.append(sel['req_per_sec'].iloc[0]) if len(sel)==1 else np.nan
    except:
    ...
    for m, method in enumerate(method_list):
        ...
        ax_TBT.plot(x_tbt, y_tbt, **style["line"],
        ...
        ax_TPOT.plot(x_tbt, y_tpot, **style["line"],
