...
def build_request_types_SML(
        ...
        mid_bins  =(4_096, 6_144, 8_192),                          # 4 K–16 K        
        long_bins =(16_384, 20_480),  # 16 K–26 K
...
if __name__ == "__main__":
    ...
    for mix in mixes:                           # mixes_h9 + mixes_k12 + mixes_l20 ...
        ...
        save_request_json(
            path=f"traces/requests_types_128k_bs8/req_{tag}.json",      # traces 폴더에 저장
            request_types=probs,
            num_req=100,
            batch_size=8,
            skip_token_ids=True,
    ...
    for req_json in Path("traces/requests_types_128k_bs8").glob("req_*.json"):
        build_sched_save(
